...
const icons = {
  ...
  globe: `<svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
...
export function renderHowItWorks(howItWorksData) {
  ...
  return `
    <section id="how-it-works" class="section how-it-works-section">
      <div class="container">
        <h2 class="section-title">Découvrir le roman</h2>
        <div class="how-grid">
          ${blocksHTML}
        </div>
      </div>
